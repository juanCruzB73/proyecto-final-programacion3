...
function useDropdownMenu(options = {}) {
  const context5 = (0, import_react31.useContext)(DropdownContext_default);
...
var InputGroupCheckbox = (props) => (0, import_jsx_runtime46.jsx)(InputGroupText_default, {
  children: (0, import_jsx_runtime46.jsx)(FormCheckInput_default, {
    type: "checkbox",
    ...props
  })
});
var InputGroupRadio = (props) => (0, import_jsx_runtime46.jsx)(InputGroupText_default, {
  children: (0, import_jsx_runtime46.jsx)(FormCheckInput_default, {
    type: "radio",
    ...props
  })
...
var InputGroup = React51.forwardRef(({
  ...
  return (0, import_jsx_runtime46.jsx)(InputGroupContext_default.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime46.jsx)(Component2, {
      ref,
      ...props,
      className: (0, import_classnames35.default)(className, bsPrefix, size2 && `${bsPrefix}-${size2}`, hasValidation && "has-validation")
    })
  });
});
...
function useWaitForDOMRef(ref, onResolved) {
  const window2 = useWindow();
  const [resolvedRef, setRef] = (0, import_react42.useState)(() => resolveContainerRef(ref, window2 == null ? void 0 : window2.document));
  if (!resolvedRef) {
...
function NoopTransition({
  ...
  const hasEnteredRef = (0, import_react43.useRef)(inProp);
  ...
  const child = (0, import_react43.cloneElement)(children, {
    ref: combinedRef
  });
...
function useRTGTransitionProps(_ref) {
  ...
  const handleEnter = (0, import_react44.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react44.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react44.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react44.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react44.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react44.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react44.useCallback)(normalize(addEndListener), [addEndListener]);
  return Object.assign({}, props, {
    ...
    ) : (0, import_react44.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var RTGTransition = React52.forwardRef((_ref, ref) => {
  let {
...
function useTransition({
  ...
  const isInitialRef = (0, import_react45.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react45.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react45.cloneElement)(children, {
    ref: combinedRef
  });
}
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react46.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react46.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react46.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react46.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
  ...
  const [exited, setExited] = (0, import_react46.useState)(!show);
  const lastFocusRef = (0, import_react46.useRef)(null);
  (0, import_react46.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react46.useRef)();
  const removeKeydownListenerRef = (0, import_react46.useRef)();
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime49.jsx)("div", Object.assign({}, dialogProps, {
    children: React54.cloneElement(children, {
      role: "document"
    })
  }));
...
var ModalBody = React55.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalDialog = React57.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
...
var AbstractModalHeader = React59.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
  ...
  const context5 = (0, import_react47.useContext)(ModalContext_default);
...
var Modal2 = React62.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react48.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react48.useState)(false);
  const waitingForMouseUpRef = (0, import_react48.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react48.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react48.useRef)(null);
  ...
  const renderBackdrop = (0, import_react48.useCallback)((backdropProps) => (0, import_jsx_runtime57.jsx)("div", {
    ...backdropProps,
...
var NavItem = React63.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var NavLink = React64.forwardRef(({
  bsPrefix,
  className,
  as: Component2 = Anchor_default,
  active,
...
var Nav = React65.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
...
var NavbarBrand = React66.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React67.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
  bsPrefix = useBootstrapPrefix(bsPrefix, "navbar-collapse");
  const context5 = (0, import_react50.useContext)(NavbarContext_default);
...
var NavbarToggle = React68.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const {
    onToggle,
    expanded
  } = (0, import_react51.useContext)(NavbarContext_default) || {};
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react52.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react53.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var OffcanvasBody = React69.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasToggling = React70.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime65.jsx)(TransitionWrapper_default, {
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React70.cloneElement(children, {
      ...innerProps,
...
var OffcanvasHeader = React71.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var OffcanvasTitle = React72.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React73.forwardRef(({
  bsPrefix,
  className,
  children,
  "aria-labelledby": ariaLabelledby,
  ...
  const modalManager = (0, import_react54.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  ...
  const renderBackdrop = (0, import_react54.useCallback)((backdropProps) => (0, import_jsx_runtime68.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React74.forwardRef(({
  onHide,
  ...props
}, ref) => {
  const context5 = (0, import_react55.useContext)(NavbarContext_default);
  const handleHide = useEventCallback(() => {
...
var NavbarText = React75.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var Navbar = React76.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand = true,
    variant = "light",
  ...
  const handleCollapse = (0, import_react56.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react56.useMemo)(() => ({
...
var NavDropdown = React77.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
  ...
  return (0, import_jsx_runtime75.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames54.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime74.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime74.jsx)(Dropdown_default2.Menu, {
      role: menuRole,
      renderOnMount: renderMenuOnMount,
      rootCloseEvent,
      variant: menuVariant,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React78.forwardRef((props, outerRef) => {
  const {
    flip: flip2,
    offset: offset2,
    placement,
  ...
  const [exited, setExited] = (0, import_react58.useState)(!props.show);
...
var PopoverHeader = React79.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React80.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Popover = React82.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style: style2,
...
var Tooltip = React83.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style: style2,
...
var Overlay2 = React84.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  const popperRef = (0, import_react60.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react60.useState)(null);
  ...
  return (0, import_jsx_runtime82.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React84.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper: popper2,
...
var OverlayTrigger = ({
  ...
  const triggerNodeRef = (0, import_react61.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout2 = useTimeout();
  const hoverStateRef = (0, import_react61.useRef)("");
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React85.Children.only(children).props : {};
  const attachRef = (r) => {
    mergedRef(safeFindDOMNode(r));
  };
  const handleShow = (0, import_react61.useCallback)(() => {
    timeout2.clear();
  ...
  const handleHide = (0, import_react61.useCallback)(() => {
    timeout2.clear();
  ...
  const handleFocus = (0, import_react61.useCallback)((...args) => {
    handleShow();
    onFocus == null || onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react61.useCallback)((...args) => {
    handleHide();
    onBlur == null || onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react61.useCallback)((...args) => {
    setShow(!show);
    onClick == null || onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react61.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react61.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime85.jsxs)(import_jsx_runtime84.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react61.cloneElement)(children, triggerProps), (0, import_jsx_runtime83.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React86.forwardRef(({
  active = false,
  disabled = false,
  className,
  style: style2,
...
function createButton(name, defaultValue, label = name) {
  const Button = React86.forwardRef(({
    children,
    ...props
...
var Pagination = React87.forwardRef(({
  bsPrefix,
  className,
  size: size2,
  ...props
...
var PlaceholderButton = React88.forwardRef((props, ref) => {
...
var Placeholder = React89.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
var ProgressBar = React90.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
  ...
  return (0, import_jsx_runtime91.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react62.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min: min2,
      now,
...
var Ratio = React91.forwardRef(({
  ...
  return (0, import_jsx_runtime92.jsx)("div", {
    ...
    children: React91.Children.only(children)
  });
});
...
var Spinner = React93.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size: size2,
...
var SplitButton = React94.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
  ...
  flip: flip2,
  ...props
}, ref) => (0, import_jsx_runtime96.jsxs)(Dropdown_default2, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime95.jsx)(Button_default2, {
    size: size2,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime95.jsx)(Dropdown_default2.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
...
function useTabPanel(_ref) {
  ...
  const context5 = (0, import_react63.useContext)(TabContext_default);
...
var TabPanel = React96.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
    ...
    return (0, import_jsx_runtime98.jsx)(TabContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime98.jsx)(SelectableContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime98.jsx)(Transition2, {
          in: isActive,
          onEnter,
          onEntering,
          onEntered,
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime98.jsx)(Component2, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react64.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react64.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime100.jsx)(Tabs_default, {
  ...props,
...
var TabContent = React99.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var TabPane = React100.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime102.jsx)(TabContext_default.Provider, {
    value: null,
    children: (0, import_jsx_runtime102.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime102.jsx)(Transition2, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
        ...
        mountOnEnter,
        unmountOnExit,
        children: (0, import_jsx_runtime102.jsx)(Component2, {
          ...rest,
          ref,
...
var Table = React101.forwardRef(({
  ...
  const table = (0, import_jsx_runtime103.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime104.jsx)(NavItem_default, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime104.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime105.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime104.jsx)(Nav_default2, {
      id,
      ...controlledProps,
      role: "tablist",
      as: "ul",
    ...
    }), (0, import_jsx_runtime104.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime104.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
var ToastFade = React103.forwardRef((props, ref) => (0, import_jsx_runtime106.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React104.createContext({
  // eslint-disable-next-line @typescript-eslint/no-empty-function
  onClose() {
  }
});
...
var ToastHeader = React105.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  const context5 = (0, import_react65.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
    context5 == null || context5.onClose == null || context5.onClose(e);
  });
  return (0, import_jsx_runtime108.jsxs)("div", {
    ref,
    ...props,
    className: (0, import_classnames71.default)(bsPrefix, className),
    children: [children, closeButton && (0, import_jsx_runtime107.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick,
      "data-dismiss": "toast"
...
var ToastBody = React106.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Toast = React107.forwardRef(({
  ...
  const delayRef = (0, import_react66.useRef)(delay);
  ...
  const autohideFunc = (0, import_react66.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react66.useMemo)(() => ({
    onClose
  }), [onClose]);
  const hasAnimation = !!(Transition2 && animation);
  const toast = (0, import_jsx_runtime110.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames73.default)(bsPrefix, className, bg && `bg-${bg}`, !hasAnimation && (show ? "show" : "hide")),
    role: "alert",
    "aria-live": "assertive",
    "aria-atomic": "true"
  });
  return (0, import_jsx_runtime110.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition2 ? (0, import_jsx_runtime110.jsx)(Transition2, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
...
var ToastContainer = React108.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
  ...
  return (0, import_jsx_runtime111.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames74.default)(bsPrefix, position && positionClasses[position], containerPosition && `position-${containerPosition}`, className)
  });
});
...
var noop6 = () => void 0;
var ToggleButton = React109.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
  ...
  return (0, import_jsx_runtime114.jsxs)(import_jsx_runtime113.Fragment, {
    children: [(0, import_jsx_runtime112.jsx)("input", {
      className: bsPrefix,
      name,
      type,
      value,
      ...
      id
    }), (0, import_jsx_runtime112.jsx)(Button_default2, {
      ...props,
      ref,
      className: (0, import_classnames75.default)(className, disabled && "disabled"),
      type: void 0,
      role: void 0,
      as: "label",
      htmlFor: id
...
var ToggleButtonGroup = React110.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
  ...
  return (0, import_jsx_runtime115.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    vertical,
    children: map(children, (child) => {
