...
} from "./chunk-QJ4LTIUL.js";
import {
  InputGroupContext_default,
  InputGroup_default
} from "./chunk-ZJRV5IKA.js";
import {
  Row_default
} from "./chunk-7IOEVWQP.js";
import {
  ...
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-H6IHSX2E.js";
import {
  require_react_dom
} from "./chunk-BVI7NZOO.js";
import {
  Button_default as Button_default2
} from "./chunk-IMO3PAKS.js";
import {
  Button_default,
  useButtonProps
} from "./chunk-ZBEGIATF.js";
import {
  ...
  map,
  require_prop_types
} from "./chunk-3MEHJ4KG.js";
import "./chunk-ZYAFMD3S.js";
import {
  Col_default,
  useCol
} from "./chunk-DMMXFJWS.js";
import {
  require_warning
} from "./chunk-L45B7X7D.js";
import {
  DEFAULT_BREAKPOINTS,
...
var AlertHeading = React13.forwardRef(({
  className,
  bsPrefix,
...
function getReactVersion() {
  const parts = React16.version.split(".");
  return {
    major: +parts[0],
    minor: +parts[1],
    patch: +parts[2]
...
var ButtonToolbar = React24.forwardRef(({
  bsPrefix,
  className,
  role = "toolbar",
  ...props
...
var CardGroup = React25.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
function useUpdateEffect(fn2, deps) {
  const isFirst = (0, import_react22.useRef)(true);
...
function useWillUnmount(fn2) {
  ...
  (0, import_react24.useEffect)(() => () => onUnmount.current(), []);
}
...
function useTimeout() {
  ...
  const handleRef = (0, import_react25.useRef)();
...
var CarouselCaption = React26.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Carousel = React28.forwardRef(({
  ...
  const nextDirectionRef = (0, import_react26.useRef)(null);
  const [direction, setDirection] = (0, import_react26.useState)("next");
  const [paused, setPaused] = (0, import_react26.useState)(false);
  const [isSliding, setIsSliding] = (0, import_react26.useState)(false);
  const [renderedActiveIndex, setRenderedActiveIndex] = (0, import_react26.useState)(activeIndex || 0);
  ...
  const prev = (0, import_react26.useCallback)((event) => {
    if (isSliding) {
      return;
    }
  ...
  const elementRef = (0, import_react26.useRef)();
  ...
  const handleEnter = (0, import_react26.useCallback)((node) => {
    triggerBrowserReflow(node);
    onSlide == null || onSlide(renderedActiveIndex, slideDirection);
  }, [onSlide, renderedActiveIndex, slideDirection]);
  const handleEntered = (0, import_react26.useCallback)(() => {
    setIsSliding(false);
    onSlid == null || onSlid(renderedActiveIndex, slideDirection);
  ...
  const handleMouseOver = (0, import_react26.useCallback)((event) => {
    if (pause === "hover") {
      setPaused(true);
    }
    onMouseOver == null || onMouseOver(event);
  }, [pause, onMouseOver]);
  const handleMouseOut = (0, import_react26.useCallback)((event) => {
    setPaused(false);
    onMouseOut == null || onMouseOut(event);
  }, [onMouseOut]);
  const touchStartXRef = (0, import_react26.useRef)(0);
  const touchDeltaXRef = (0, import_react26.useRef)(0);
  const touchUnpauseTimeout = useTimeout();
  const handleTouchStart = (0, import_react26.useCallback)((event) => {
  ...
  const handleTouchMove = (0, import_react26.useCallback)((event) => {
  ...
  const handleTouchEnd = (0, import_react26.useCallback)((event) => {
    if (touch) {
  ...
  const intervalHandleRef = (0, import_react26.useRef)();
  (0, import_react26.useEffect)(() => {
  ...
  const indicatorOnClicks = (0, import_react26.useMemo)(() => indicators && Array.from({
    length: numChildren
  }, (_, index) => (event) => {
    ...
    children: [indicators && (0, import_jsx_runtime24.jsx)("div", {
      ...
      children: map(children, (child, index) => {
        ...
        return slide ? (0, import_jsx_runtime24.jsx)(TransitionWrapper_default, {
          ...
          addEndListener: transitionEndListener,
          children: (status, innerProps) => React28.cloneElement(child, {
            ...innerProps,
...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  ...
  return [isProp ? propValue : stateValue, (0, import_react27.useCallback)((...args) => {
...
function useSafeState(state) {
  const isMounted = useMounted();
  return [state[0], (0, import_react28.useCallback)((nextState) => {
    if (!isMounted()) return;
...
function useDropdownMenu(options = {}) {
  const context4 = (0, import_react31.useContext)(DropdownContext_default);
  const [arrowElement, attachArrowRef] = useCallbackRef();
  const hasShownRef = (0, import_react31.useRef)(false);
  const {
    flip: flip2,
    offset: offset2,
    rootCloseEvent,
...
var $b5e257d569688ac6$var$SSRContext = (0, import_react32.default).createContext($b5e257d569688ac6$var$defaultContext);
var $b5e257d569688ac6$var$IsSSRContext = (0, import_react32.default).createContext(false);
function $b5e257d569688ac6$var$LegacySSRProvider(props) {
  let cur = (0, import_react32.useContext)($b5e257d569688ac6$var$SSRContext);
  let counter = $b5e257d569688ac6$var$useCounter(cur === $b5e257d569688ac6$var$defaultContext);
  let [isSSR, setIsSSR] = (0, import_react32.useState)(true);
  let value = (0, import_react32.useMemo)(() => ({
  ...
  return (0, import_react32.default).createElement($b5e257d569688ac6$var$SSRContext.Provider, {
    value
  }, (0, import_react32.default).createElement($b5e257d569688ac6$var$IsSSRContext.Provider, {
    value: isSSR
  }, props.children));
}
var $b5e257d569688ac6$var$warnedAboutSSRProvider = false;
function $b5e257d569688ac6$export$9f8ac96af4b1b2ae(props) {
  if (typeof (0, import_react32.default)["useId"] === "function") {
    if (!$b5e257d569688ac6$var$warnedAboutSSRProvider) {
      console.warn("In React 18, SSRProvider is not necessary and is a noop. You can remove it from your app.");
      $b5e257d569688ac6$var$warnedAboutSSRProvider = true;
    }
    return (0, import_react32.default).createElement((0, import_react32.default).Fragment, null, props.children);
  }
  return (0, import_react32.default).createElement($b5e257d569688ac6$var$LegacySSRProvider, props);
}
var $b5e257d569688ac6$var$canUseDOM = Boolean(typeof window !== "undefined" && window.document && window.document.createElement);
var $b5e257d569688ac6$var$componentIds = /* @__PURE__ */ new WeakMap();
function $b5e257d569688ac6$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react32.useContext)($b5e257d569688ac6$var$SSRContext);
  let ref = (0, import_react32.useRef)(null);
  if (ref.current === null && !isDisabled) {
    var _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner, _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    let currentOwner = (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = (0, import_react32.default).__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED === void 0 ? void 0 : (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner = _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner === void 0 ? void 0 : _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner.current;
    if (currentOwner) {
...
function $b5e257d569688ac6$var$useModernSSRSafeId(defaultId) {
  let id = (0, import_react32.default).useId();
  let [didSSR] = (0, import_react32.useState)($b5e257d569688ac6$export$535bd6ca7f90a273());
  let prefix = didSSR || false ? "react-aria" : `react-aria${$b5e257d569688ac6$var$defaultContext.prefix}`;
  return defaultId || `${prefix}-${id}`;
}
var $b5e257d569688ac6$export$619500959fc48b26 = typeof (0, import_react32.default)["useId"] === "function" ? $b5e257d569688ac6$var$useModernSSRSafeId : $b5e257d569688ac6$var$useLegacySSRSafeId;
...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
  if (typeof (0, import_react32.default)["useSyncExternalStore"] === "function") return (0, import_react32.default)["useSyncExternalStore"]($b5e257d569688ac6$var$subscribe, $b5e257d569688ac6$var$getSnapshot, $b5e257d569688ac6$var$getServerSnapshot);
  return (0, import_react32.useContext)($b5e257d569688ac6$var$IsSSRContext);
}
...
var DropdownItem = React33.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime30.jsx)(Component2, Object.assign({}, props, {
    ref
  }, dropdownItemProps));
});
...
function Dropdown({
  ...
  return (0, import_jsx_runtime31.jsx)(SelectableContext_default.Provider, {
    value: handleSelect,
    children: (0, import_jsx_runtime31.jsx)(DropdownContext_default.Provider, {
      value: context4,
      children
    })
  });
...
function useWrappedRefWithWarning(ref, componentName) {
  if (false) return ref;
  const warningRef = (0, import_react37.useCallback)((refValue) => {
...
var DropdownMenu2 = React41.forwardRef(({
  ...
  let alignEnd = false;
  const isNavbar = (0, import_react38.useContext)(NavbarContext_default);
  const prefix = useBootstrapPrefix(bsPrefix, "dropdown-menu");
  const {
    align: contextAlign,
    drop,
    isRTL
  } = (0, import_react38.useContext)(DropdownContext_default2);
  align = align || contextAlign;
  const isInputGroup = (0, import_react38.useContext)(InputGroupContext_default);
  const alignClasses = [];
  if (align) {
...
var DropdownToggle2 = React42.forwardRef(({
  ...
  const dropdownContext = (0, import_react39.useContext)(DropdownContext_default);
...
var Image2 = React45.forwardRef(({
  ...
  return (0, import_jsx_runtime41.jsx)("img", {
...
var FigureImage = React46.forwardRef(({
  ...
  fluid = true,
  ...props
}, ref) => (0, import_jsx_runtime42.jsx)(Image_default, {
  ref,
  ...props,
  fluid,
...
function useWaitForDOMRef(ref, onResolved) {
  const window2 = useWindow();
  const [resolvedRef, setRef] = (0, import_react41.useState)(() => resolveContainerRef(ref, window2 == null ? void 0 : window2.document));
  if (!resolvedRef) {
...
function NoopTransition({
  ...
  const hasEnteredRef = (0, import_react42.useRef)(inProp);
  ...
  const child = (0, import_react42.cloneElement)(children, {
    ref: combinedRef
  });
...
function useRTGTransitionProps(_ref) {
  ...
  const handleEnter = (0, import_react43.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react43.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react43.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react43.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react43.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react43.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react43.useCallback)(normalize(addEndListener), [addEndListener]);
  return Object.assign({}, props, {
    ...
    ) : (0, import_react43.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var RTGTransition = React49.forwardRef((_ref, ref) => {
  let {
    component: Component2
  } = _ref, props = _objectWithoutPropertiesLoose7(_ref, _excluded6);
  const transitionProps = useRTGTransitionProps(props);
  return (0, import_jsx_runtime45.jsx)(Component2, Object.assign({
    ref
  }, transitionProps));
});
...
function useTransition({
  ...
  const isInitialRef = (0, import_react44.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react44.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react44.cloneElement)(children, {
    ref: combinedRef
  });
}
function renderTransition(component, runTransition, props) {
  if (component) {
    return (0, import_jsx_runtime46.jsx)(RTGTransition_default, Object.assign({}, props, {
      component
    }));
  }
  if (runTransition) {
    return (0, import_jsx_runtime46.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime46.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react45.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react45.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react45.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react45.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime47.jsx)("div", Object.assign({}, props)),
  ...
  const [exited, setExited] = (0, import_react45.useState)(!show);
  const lastFocusRef = (0, import_react45.useRef)(null);
  (0, import_react45.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react45.useRef)();
  const removeKeydownListenerRef = (0, import_react45.useRef)();
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime47.jsx)("div", Object.assign({}, dialogProps, {
    children: React51.cloneElement(children, {
      role: "document"
    })
  }));
  ...
  return (0, import_jsx_runtime47.jsx)(import_jsx_runtime47.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime47.jsxs)(import_jsx_runtime47.Fragment, {
...
var ModalContext = React53.createContext({
...
var AbstractModalHeader = React56.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
  ...
  const context4 = (0, import_react46.useContext)(ModalContext_default);
  ...
  return (0, import_jsx_runtime52.jsxs)("div", {
    ref,
    ...props,
    children: [children, closeButton && (0, import_jsx_runtime51.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick
    })]
...
var ModalHeader = React57.forwardRef(({
  ...
  return (0, import_jsx_runtime53.jsx)(AbstractModalHeader_default, {
    ref,
    ...props,
...
function DialogTransition(props) {
  return (0, import_jsx_runtime55.jsx)(Fade_default, {
    ...props,
    timeout: null
  });
}
...
var Modal2 = React59.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react47.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react47.useState)(false);
  const waitingForMouseUpRef = (0, import_react47.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react47.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react47.useRef)(null);
  ...
  const renderBackdrop = (0, import_react47.useCallback)((backdropProps) => (0, import_jsx_runtime55.jsx)("div", {
    ...backdropProps,
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime55.jsx)("div", {
    role: "dialog",
    ...dialogProps,
    ...
    "aria-labelledby": ariaLabelledby,
    "aria-describedby": ariaDescribedby,
    children: (0, import_jsx_runtime55.jsx)(Dialog, {
      ...props,
  ...
  return (0, import_jsx_runtime55.jsx)(ModalContext_default.Provider, {
    value: modalContext,
    children: (0, import_jsx_runtime55.jsx)(Modal_default, {
      show,
      ref: mergedRef,
      backdrop,
      container,
...
var NavItem = React60.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var NavLink = React61.forwardRef(({
  bsPrefix,
  className,
  as: Component2 = Anchor_default,
  active,
  ...
  return (0, import_jsx_runtime57.jsx)(Component2, {
    ...
    ref,
    disabled,
    className: (0, import_classnames41.default)(className, bsPrefix, disabled && "disabled", meta.isActive && "active")
  });
});
...
var Nav = React62.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
  ...
  let isNavbar = false;
  const navbarContext = (0, import_react48.useContext)(NavbarContext_default);
  const cardHeaderContext = (0, import_react48.useContext)(CardHeaderContext_default);
  if (navbarContext) {
  ...
  return (0, import_jsx_runtime58.jsx)(Nav_default, {
    as,
    ref,
    activeKey,
    className: (0, import_classnames42.default)(className, {
      [bsPrefix]: !isNavbar,
...
var NavbarBrand = React63.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React64.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
  bsPrefix = useBootstrapPrefix(bsPrefix, "navbar-collapse");
  const context4 = (0, import_react49.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime60.jsx)(Collapse_default, {
...
var NavbarToggle = React65.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  return (0, import_jsx_runtime61.jsx)(Component2, {
    ...
    onClick: handleClick,
    "aria-label": label,
    className: (0, import_classnames44.default)(className, bsPrefix, !expanded && "collapsed"),
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react51.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react52.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var OffcanvasBody = React66.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasToggling = React67.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime63.jsx)(TransitionWrapper_default, {
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React67.cloneElement(children, {
      ...innerProps,
      className: (0, import_classnames46.default)(className, children.props.className, (status === ENTERING || status === EXITING) && `${bsPrefix}-toggling`, transitionStyles[status])
    })
  });
});
...
var OffcanvasHeader = React68.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var OffcanvasTitle = React69.forwardRef(({
  className,
  bsPrefix,
...
function DialogTransition2(props) {
  return (0, import_jsx_runtime66.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
function BackdropTransition2(props) {
  return (0, import_jsx_runtime66.jsx)(Fade_default, {
    ...props
  });
}
var Offcanvas = React70.forwardRef(({
  ...
  const modalManager = (0, import_react53.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const [showOffcanvas, setShowOffcanvas] = (0, import_react53.useState)(false);
  const handleHide = useEventCallback(onHide);
  ...
  const renderBackdrop = (0, import_react53.useCallback)((backdropProps) => (0, import_jsx_runtime66.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames49.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime66.jsx)("div", {
    ...dialogProps,
    ...props,
  ...
  return (0, import_jsx_runtime68.jsxs)(import_jsx_runtime67.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime66.jsx)(ModalContext_default.Provider, {
      value: modalContext,
      children: (0, import_jsx_runtime66.jsx)(Modal_default, {
        show: showOffcanvas,
        ref,
        backdrop,
        container,
...
var NavbarOffcanvas = React71.forwardRef(({
  onHide,
  ...props
}, ref) => {
  const context4 = (0, import_react54.useContext)(NavbarContext_default);
  const handleHide = useEventCallback(() => {
    context4 == null || context4.onToggle == null || context4.onToggle();
    onHide == null || onHide();
  });
  return (0, import_jsx_runtime69.jsx)(Offcanvas_default, {
    ref,
...
var NavbarText = React72.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var Navbar = React73.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand = true,
    variant = "light",
  ...
  const handleCollapse = (0, import_react55.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react55.useMemo)(() => ({
    onToggle: () => onToggle == null ? void 0 : onToggle(!expanded),
    bsPrefix,
    expanded: !!expanded,
    expand
  }), [bsPrefix, expanded, expand, onToggle]);
  return (0, import_jsx_runtime71.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
    children: (0, import_jsx_runtime71.jsx)(SelectableContext_default.Provider, {
      value: handleCollapse,
      children: (0, import_jsx_runtime71.jsx)(Component2, {
        ref,
        ...controlledProps,
        className: (0, import_classnames51.default)(className, bsPrefix, expand && expandClass, variant && `${bsPrefix}-${variant}`, bg && `bg-${bg}`, sticky && `sticky-${sticky}`, fixed && `fixed-${fixed}`)
      })
    })
  });
});
...
var NavDropdown = React74.forwardRef(({
  ...
  return (0, import_jsx_runtime73.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames52.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime72.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
...
var Overlay = React75.forwardRef((props, outerRef) => {
  ...
  const [exited, setExited] = (0, import_react57.useState)(!props.show);
...
var Popover = React79.forwardRef(({
  ...
  return (0, import_jsx_runtime77.jsxs)("div", {
    ...
    className: (0, import_classnames55.default)(className, decoratedBsPrefix, primaryPlacement && `bs-popover-${bsDirection}`),
    ...props,
    children: [(0, import_jsx_runtime76.jsx)("div", {
      className: "popover-arrow",
      ...arrowProps
    }), body ? (0, import_jsx_runtime76.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
var Tooltip = React80.forwardRef(({
  ...
  return (0, import_jsx_runtime79.jsxs)("div", {
    ...
    role: "tooltip",
    "x-placement": primaryPlacement,
    className: (0, import_classnames56.default)(className, bsPrefix, `bs-tooltip-${bsDirection}`),
    ...props,
...
function useOverlayOffset(customOffset) {
  ...
  const offset2 = (0, import_react58.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var Overlay2 = React81.forwardRef(({
  ...
  const popperRef = (0, import_react59.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react59.useState)(null);
  ...
  return (0, import_jsx_runtime80.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
    ...
    children: (overlayProps, {
      ...
      return React81.cloneElement(overlay, {
        ...
        popper: popper2,
        hasDoneInitialMeasure,
        className: (0, import_classnames57.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
var OverlayTrigger = ({
  ...
  const triggerNodeRef = (0, import_react60.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout2 = useTimeout();
  const hoverStateRef = (0, import_react60.useRef)("");
  ...
  const handleShow = (0, import_react60.useCallback)(() => {
    timeout2.clear();
  ...
  const handleHide = (0, import_react60.useCallback)(() => {
    timeout2.clear();
  ...
  const handleFocus = (0, import_react60.useCallback)((...args) => {
    handleShow();
    onFocus == null || onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react60.useCallback)((...args) => {
    handleHide();
    onBlur == null || onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react60.useCallback)((...args) => {
    setShow(!show);
    onClick == null || onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react60.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react60.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime83.jsxs)(import_jsx_runtime82.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react60.cloneElement)(children, triggerProps), (0, import_jsx_runtime81.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React83.forwardRef(({
  ...
  return (0, import_jsx_runtime84.jsx)("li", {
    ref,
    style: style2,
    className: (0, import_classnames58.default)(className, "page-item", {
      active,
      disabled
    }),
    children: (0, import_jsx_runtime85.jsxs)(Component2, {
      className: (0, import_classnames58.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
...
function createButton(name, defaultValue, label = name) {
  const Button = React83.forwardRef(({
    children,
    ...props
  }, ref) => (0, import_jsx_runtime85.jsxs)(PageItem, {
    ...props,
    ref,
...
var Pagination = React84.forwardRef(({
  ...
  return (0, import_jsx_runtime86.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames59.default)(className, decoratedBsPrefix, size2 && `${decoratedBsPrefix}-${size2}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames60.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size2 && `${bsPrefix}-${size2}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React85.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime87.jsx)(Button_default2, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime89.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames61.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
...
var ProgressBar = React87.forwardRef(({
  ...
  return (0, import_jsx_runtime89.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react61.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min: min2,
      now,
...
var Ratio = React88.forwardRef(({
  ...
  return (0, import_jsx_runtime90.jsx)("div", {
    ...
    className: (0, import_classnames62.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
...
var Spinner = React89.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size: size2,
...
var SplitButton = React90.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
  ...
  flip: flip2,
  ...props
}, ref) => (0, import_jsx_runtime93.jsxs)(Dropdown_default2, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime92.jsx)(Button_default2, {
    size: size2,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime92.jsx)(Dropdown_default2.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
...
function useTabPanel(_ref) {
  ...
  const context4 = (0, import_react62.useContext)(TabContext_default);
...
var TabPanel = React92.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
    ...
    return (0, import_jsx_runtime95.jsx)(TabContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime95.jsx)(SelectableContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime95.jsx)(Transition2, {
          in: isActive,
          onEnter,
          onEntering,
          onEntered,
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime95.jsx)(Component2, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react63.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react63.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime97.jsx)(Tabs_default, {
  ...props,
...
var TabPane = React96.forwardRef(({
  ...
  return (0, import_jsx_runtime99.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime99.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime99.jsx)(Transition2, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
        ...
        mountOnEnter,
        unmountOnExit,
        children: (0, import_jsx_runtime99.jsx)(Component2, {
          ...rest,
          ref,
...
var Table = React97.forwardRef(({
  ...
  const table = (0, import_jsx_runtime100.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime101.jsx)(NavItem_default, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime101.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime102.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime101.jsx)(Nav_default2, {
      id,
      ...controlledProps,
      role: "tablist",
      as: "ul",
    ...
    }), (0, import_jsx_runtime101.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime101.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
var ToastFade = React99.forwardRef((props, ref) => (0, import_jsx_runtime103.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React101.forwardRef(({
  ...
  const context4 = (0, import_react64.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
    context4 == null || context4.onClose == null || context4.onClose(e);
  });
  return (0, import_jsx_runtime105.jsxs)("div", {
    ref,
    ...props,
    className: (0, import_classnames68.default)(bsPrefix, className),
    children: [children, closeButton && (0, import_jsx_runtime104.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick,
      "data-dismiss": "toast"
...
var Toast = React103.forwardRef(({
  ...
  const delayRef = (0, import_react65.useRef)(delay);
  ...
  const autohideFunc = (0, import_react65.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react65.useMemo)(() => ({
    onClose
  }), [onClose]);
  const hasAnimation = !!(Transition2 && animation);
  const toast = (0, import_jsx_runtime107.jsx)("div", {
    ...props,
    ref,
  ...
  return (0, import_jsx_runtime107.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition2 ? (0, import_jsx_runtime107.jsx)(Transition2, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
...
var ToggleButton = React105.forwardRef(({
  ...
  return (0, import_jsx_runtime111.jsxs)(import_jsx_runtime110.Fragment, {
    children: [(0, import_jsx_runtime109.jsx)("input", {
      className: bsPrefix,
      name,
      type,
      value,
      ...
      id
    }), (0, import_jsx_runtime109.jsx)(Button_default2, {
      ...props,
      ref,
...
var ToggleButtonGroup = React106.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime112.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    vertical,
    children: map(children, (child) => {
